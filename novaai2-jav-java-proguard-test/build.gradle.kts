...
dependencies {
    testImplementation(project(":novaai2-jav-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../novaai2-jav-java-core/src/main/resources/META-INF/proguard/novaai2-jav-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.configure_me_novaai2_jav.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../novaai2-jav-java-core/src/main/resources/META-INF/proguard/novaai2-jav-java-core.pro",
