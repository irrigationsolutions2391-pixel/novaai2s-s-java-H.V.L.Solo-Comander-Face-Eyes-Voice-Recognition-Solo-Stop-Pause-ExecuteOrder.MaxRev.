...
import com.configure_me_novaai2_jav.api.client.Novaai2JavClientImpl
...
/**
 * A class that allows building an instance of [Novaai2JavClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class Novaai2JavOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [Novaai2JavClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): Novaai2JavClient = builder().fromEnv().build()
    }

    /** A builder for [Novaai2JavOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [Novaai2JavClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): Novaai2JavClient =
            Novaai2JavClientImpl(
                clientOptions
                    .httpClient(
