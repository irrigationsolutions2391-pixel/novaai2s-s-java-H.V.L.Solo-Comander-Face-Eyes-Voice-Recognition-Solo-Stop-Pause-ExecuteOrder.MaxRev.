...
package com.configure_me_novaai2_jav.api.client.okhttp

import com.configure_me_novaai2_jav.api.client.Novaai2JavClientAsync
import com.configure_me_novaai2_jav.api.client.Novaai2JavClientAsyncImpl
import com.configure_me_novaai2_jav.api.core.ClientOptions
import com.configure_me_novaai2_jav.api.core.Sleeper
import com.configure_me_novaai2_jav.api.core.Timeout
import com.configure_me_novaai2_jav.api.core.http.Headers
import com.configure_me_novaai2_jav.api.core.http.HttpClient
import com.configure_me_novaai2_jav.api.core.http.QueryParams
import com.configure_me_novaai2_jav.api.core.jsonMapper
...
/**
 * A class that allows building an instance of [Novaai2JavClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class Novaai2JavOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [Novaai2JavClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): Novaai2JavClientAsync = builder().fromEnv().build()
    }

    /** A builder for [Novaai2JavOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.configure_me_novaai2_jav.api.core.jsonMapper]. The default is usually
        ...
        /**
         * Returns an immutable instance of [Novaai2JavClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): Novaai2JavClientAsync =
            Novaai2JavClientAsyncImpl(
                clientOptions
                    .httpClient(
