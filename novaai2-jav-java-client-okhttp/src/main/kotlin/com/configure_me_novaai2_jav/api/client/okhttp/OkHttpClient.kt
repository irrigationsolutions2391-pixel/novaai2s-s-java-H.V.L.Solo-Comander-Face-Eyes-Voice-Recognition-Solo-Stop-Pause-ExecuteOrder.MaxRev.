...
import com.configure_me_novaai2_jav.api.core.http.HttpRequestBody
import com.configure_me_novaai2_jav.api.core.http.HttpResponse
import com.configure_me_novaai2_jav.api.errors.Novaai2JavIoException
...
private constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw Novaai2JavIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(Novaai2JavIoException("Request failed", e))
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("NOVAAI2_JAV_LOG")?.lowercase()) {
