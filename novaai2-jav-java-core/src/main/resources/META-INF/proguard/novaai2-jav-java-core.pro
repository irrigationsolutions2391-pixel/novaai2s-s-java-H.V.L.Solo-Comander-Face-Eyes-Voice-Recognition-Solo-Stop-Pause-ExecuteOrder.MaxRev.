...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.configure_me_novaai2_jav.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.configure_me_novaai2_jav.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.configure_me_novaai2_jav.api.** {
    <init>(...);
