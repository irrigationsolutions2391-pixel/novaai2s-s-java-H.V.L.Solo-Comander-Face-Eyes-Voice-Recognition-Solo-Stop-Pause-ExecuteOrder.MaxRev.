...
/**
 * A client for interacting with the Novaai2 Jav REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface Novaai2JavClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): Novaai2JavClientAsync
    ...
    /**
     * A view of [Novaai2JavClientAsync] that provides access to raw HTTP responses for each method.
     */
