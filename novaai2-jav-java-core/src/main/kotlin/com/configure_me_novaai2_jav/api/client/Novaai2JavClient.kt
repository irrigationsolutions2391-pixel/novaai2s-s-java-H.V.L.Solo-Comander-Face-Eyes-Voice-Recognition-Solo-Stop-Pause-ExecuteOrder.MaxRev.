...
/**
 * A client for interacting with the Novaai2 Jav REST API synchronously. You can also switch to
...
interface Novaai2JavClient {
     ...
     * this client.
     */
    fun async(): Novaai2JavClientAsync
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): Novaai2JavClient
    ...
    /** A view of [Novaai2JavClient] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): Novaai2JavClient.WithRawResponse
