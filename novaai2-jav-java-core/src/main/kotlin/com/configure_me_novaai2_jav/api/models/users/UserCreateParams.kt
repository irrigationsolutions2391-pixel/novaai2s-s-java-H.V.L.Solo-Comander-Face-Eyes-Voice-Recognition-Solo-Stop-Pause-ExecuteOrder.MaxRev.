...
import com.configure_me_novaai2_jav.api.core.immutableEmptyMap
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UserCreateParams = builder().build()
    ...
    override fun hashCode(): Int = Objects.hash(user, additionalHeaders, additionalQueryParams)
