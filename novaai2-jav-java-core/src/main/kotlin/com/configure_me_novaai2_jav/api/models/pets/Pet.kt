...
package com.configure_me_novaai2_jav.api.models.pets

import com.configure_me_novaai2_jav.api.core.Enum
import com.configure_me_novaai2_jav.api.core.ExcludeMissing
...
import com.configure_me_novaai2_jav.api.core.checkKnown
import com.configure_me_novaai2_jav.api.core.checkRequired
import com.configure_me_novaai2_jav.api.core.toImmutable
...
private constructor(
    ...
    /**
     * @throws Novaai2JavInvalidDataException if the JSON field has an unexpected type or is
    ...
    /**
     * @throws Novaai2JavInvalidDataException if the JSON field has an unexpected type (e.g. if the
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: Novaai2JavInvalidDataException) {
            false
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws Novaai2JavInvalidDataException if this class instance's value is a not a known
         *   member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw Novaai2JavInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws Novaai2JavInvalidDataException if this class instance's value does not have the
         *   expected primitive type.
         */
        fun asString(): String =
            _value().asString().orElseThrow {
                Novaai2JavInvalidDataException("Value is not a String")
            }
    ...
    private constructor(
        ...
        /**
         * @throws Novaai2JavInvalidDataException if the JSON field has an unexpected type (e.g. if
